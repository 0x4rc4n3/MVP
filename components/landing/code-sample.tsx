...
export function DeveloperIntegration() {
  ...
  return (
    <section id="integration" className="bg-background flex flex-col justify-between scroll-mt-[64px]">
      {/* 90vh Body container - fully centered content */}
      <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-16 my-auto w-full flex flex-col justify-center space-y-6 h-[90vh] min-h-[90vh] py-2">
        {/* Section header */}
      ...
      <div className="h-[5vh] min-h-[5vh] flex items-center justify-center relative z-20">
        <a
          ...
          aria-label={isScrolled ? "Scroll to previous section" : "Scroll to next section"}
        >
